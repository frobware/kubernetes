...
func StartTestServer(t *testing.T, flags []string, storageConfig *storagebackend.Config) (result *restclient.Config, opts *options.ServerRunOptions, tearDownForCaller TearDownFunc, err error) {
	var tmpDir string
