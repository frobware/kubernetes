...
import (
	...
	alwaysqualifyimagesapiv1alpha1 "k8s.io/kubernetes/plugin/pkg/admission/alwaysqualifyimages/apis/alwaysqualifyimages/v1alpha1"
	"k8s.io/kubernetes/plugin/pkg/admission/alwaysqualifyimages/apis/alwaysqualifyimages/validation"
)
